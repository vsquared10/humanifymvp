var TableViewCell = React.createClass({
  ...
  renderChildren() {
    ...
    if (this.props.href || chevronDirection) {
      ...
      return (
        <a href={this.props.href} className={classes} children={this.props.children} />
      )
    } else {
  ...
  renderDivider() {
    return (
      <li {...this.props} className={cx(this.props.className, "table-view-divider")} children={this.props.children} href={null} />
    )
  },
  render() {
